...
public class VerPlanFragment extends Fragment implements View.OnClickListener {
    ...
    ImageView imageView;
    EditText nombre, descripcion,fecha, hora, plancreador, asistentes, estado, lugar;
    Button ver_mapa, ir;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imageView = (ImageView) v.findViewById(R.id.image_VerPlan);

        nombre = (EditText) v.findViewById(R.id.plan_nombre);
        descripcion = (EditText) v.findViewById(R.id.plan_descripcion);
        fecha = (EditText) v.findViewById(R.id.plan_fecha);
        hora = (EditText) v.findViewById(R.id.plan_Hora);
        plancreador = (EditText) v.findViewById(R.id.plan_creador);
        estado = (EditText) v.findViewById(R.id.estado);
        asistentes = (EditText) v.findViewById(R.id.plan_numero_participantes);

        lugar = (EditText) v.findViewById(R.id.plan_lugar);
    ...
    public void Load_data(){
        if (ListaFragment.POSITION!=-1){
            Picasso.with(context)
                    .load(Uri.parse(AppUtil.data.get(ListaFragment.POSITION).getImagen()))
                    .into(imageView);
            ...
            lugar.setText(AppUtil.data.get(ListaFragment.POSITION).getDireccion());
